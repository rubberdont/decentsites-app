...
interface DaySlotsListProps {
  ...
  /** Callback for closing mobile sheet */
  onClose?: () => void;
}
  ...
  if (isMobileSheet) {
    return (
      <>
        ...
        {/* Mobile Bottom Sheet */}
        <div 
          className="fixed bottom-0 left-0 right-0 z-30 max-h-[60vh] bg-admin-bg-card rounded-t-2xl shadow-[0_-5px_15px_rgba(0,0,0,0.2)] transform transition-transform duration-300 ease-in-out translate-y-0"
          onTouchStart={(e) => {
        ...
        >
          ...
          {/* Scrollable Content */}
          <div className="overflow-y-auto max-h-[calc(60vh-3rem)] px-4 pb-4">
            {/* Template Selector */}
            ...
            {/* Main Card */}
            <div className="bg-admin-bg-card rounded-lg border border-admin-border mt-4">
              {/* Header */}
